...
const userInfo = async (req, res) => {
    const { firstName, lastName, nationality, dateOfBirth, country, address, tag, bvn, password } = req.body

    if (!firstName || !lastName || !nationality || !dateOfBirth || !country || !address || !bvn || !password || !tag) {
